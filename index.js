...
class SinglyLinkedList {
  ...
  splitOnVal(val) {
    let walker = null;
    let runner = this.head;
    let newList = new SinglyLinkedList(0);
...
// secondThreeList.concat(unorderedList).printArr();
unorderedList.moveMinToFront().printArr();
// unorderedList.splitOnVal(6).printArr();
